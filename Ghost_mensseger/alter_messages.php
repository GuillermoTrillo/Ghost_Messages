...
<div id ="cab_reg">
        ...
        <a href = ""><h1 id = "h1_cab_reg"> Edite sua mensagem! </h1> </a>
        </div>
    ...
    <div>
        ...
        <form id = "dentro_form_reg" method="POST" >   
              ...
              <br>
              <input type="hidden" id="id_message" name="id_message" value="<?php echo $id; ?>" />
    ...
    <div>
        ...
        <script src="js/messages_alter.js"> </script>
</body>
</html>